...
struct Utilities {
    ...
    let category: [Categories] = [
        Categories(categoryName: "Face", subcategories: [
            SubCategories(habitName: "Sheet Mask", description: "Facial mask will help you to solve your skin concern, and you can use it 1-3 times per week or look the instructions on the product label.", period: "Weekly", timeInMinutes: 15, notes: "All Skin Type"),
            SubCategories(habitName: "Sleeping Mask", description: "Facial mask will help you to solve your skin concern, and you can use it 1-3 times per week or look the instructions on the product label.", period: "Weekly", timeInMinutes: 480, notes: "All Skin Type"),
            ...
            SubCategories(habitName: "Clay Mask", description: "Facial mask will help you to solve your skin concern, and you can use it 1-3 times per week or look the instructions on the product label.", period: "Weekly", timeInMinutes: 20, notes: "Oily Skin and Combination Skin"),
            SubCategories(habitName: "Charcoal Mask", description: "Facial mask will help you to solve your skin concern, and you can use it 1-3 times per week or look the instructions on the product label.", period: "Weekly", timeInMinutes: 20, notes: "Oily Skin and Combination Skin"),
            SubCategories(habitName: "Cream Mask", description: "Facial mask will help you to solve your skin concern, and you can use it 1-3 times per week or look the instructions on the product label.", period: "Weekly", timeInMinutes: 20, notes: "Dry Skin"),
            SubCategories(habitName: "Chemical Face Exfoliation", description: "Chemical Exfoliator will help you to sloughs off dead skin. The product is a combination of safe-for-skin acids. You can exfoliate your skin maximum 3 times per week.", period: "Weekly", timeInMinutes: 1, notes: "Sensitive"),
            SubCategories(habitName: "Peel-Off Mask", description: "Facial mask will help you to solve your skin concern, and you can use it 1-3 times per week or look the instructions on the product label.", period: "Weekly", timeInMinutes: 5, notes: "Not for Sensitive Skin"),
            SubCategories(habitName: "Lip Exfoliation Routine", description: "Lip care routine is great for dry lips, you only need to exfoliate if you have a dry lips. You can exfoliate your lips 1-2 times per week. Exfoliate using scrub then moisturise using balm.", period: "Weekly", timeInMinutes: 5, notes: ""),
            SubCategories(habitName: "Face Serum", description: "Face serum is a light moisturiser packed with full of active ingredients. Serum is the problem solver for your skin concerns. Use it base on the product label information.", period: "Weekly", timeInMinutes: 5, notes: ""),
            SubCategories(habitName: "Treatment", description: "Treatment products are used to address specific skin concerns such as acne, dark spots, hyperpigmentation, fine lines and inflammation.", period: "Weekly", timeInMinutes: 5, notes: "")
        ]),
        ...
        Categories(categoryName: "Health", subcategories: [
            ...
            // MARK: Change timeInMinutes into notes: String
            ...
            // MARK: Change timeInMinutes into notes: String = "8 glasses"
            ...
            // MARK: Change timeInMinutes into notes: String = 6 - 8 hrs
